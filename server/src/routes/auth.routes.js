...
const { register, login, logout, refreshToken, getProfile, updateProfile, changePassword, forgotPassword, resetPassword, googleCallback, facebookCallback, twitterCallback } = require("../controllers/auth.controllers");
